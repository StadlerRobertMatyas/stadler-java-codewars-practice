package com.stadlerrobertmatyas.extra;

// Extra knowledge!
public class BitwiseOperatorExample {

    // TODO: https://www.geeksforgeeks.org/bitwise-operators-in-java/ (homework)
    public static void main(String[] args) {

        // TODO: bitwise calc https://miniwebtool.com/bitwise-calculator/
        int x = 5;
        int y = 10;
        ...
        int resultBitwiseOR = x | y; // 5 (0101) | 10 (1010) = 15 (1111)
        System.out.println("Bitwise OR result: " + resultBitwiseOR); // Kiírja: 15

        int a = 5; // 0101
        int b = 7; // 0111
        System.out.println("Bitwise or 5 - 7: " + (a | b)); // 7 -  0111
        ...
        int resultBitwiseAND = x & y; // 5 (0101) & 10 (1010) = 0 (0)
        ...
        */
        ...
        Az x és y változók értékei 5 és 10. Binárisan ezek 0101 és 1010. Az XOR művelet végzi el a két szám bináris
