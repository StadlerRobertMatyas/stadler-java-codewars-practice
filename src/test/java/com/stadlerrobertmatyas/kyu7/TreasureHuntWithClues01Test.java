...
public class TreasureHuntWithClues01Test {
    @Test
    public void simpleTests() {
        ...
        assertEquals(31, TreasureHuntWithClues01.findTreasure(grid1, 3, 4));

        // A different starting position leads to a different treasure.
        assertEquals(21, TreasureHuntWithClues01.findTreasure(grid1, 1, 2));
        ...
        assertEquals(98, TreasureHuntWithClues01.findTreasure(grid2, 1, 1));
    }

    @Test
    public void specialCases() {
        // n=1
        assertEquals(11, TreasureHuntWithClues01.findTreasure(new int[][]{{11}}, 1, 1));

        // All values the same
        assertEquals(21, TreasureHuntWithClues01.findTreasure(
        ...
        assertEquals(55, TreasureHuntWithClues01.findTreasure(grid3, 1, 1));
        ...
        assertEquals(34, TreasureHuntWithClues01.findTreasure(grid4, 1, 5));
    }
}
